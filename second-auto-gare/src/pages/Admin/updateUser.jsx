...
function UpdateUser() {
  ...
  const { singleUser: user, singleUserLoading: isLoading } = useSelector(
    (state) => state.user
  );
  ...
  const OnSubmit = async (data) => {
    ...
    dispatch(Updateuser({ id: user?._id, data: formData })).then(() => {
      dispatch(GetSingleUser({ id: user?._id }));
    });
  };
      ...
      {user && (
        <div className="container mx-auto">
          <div className="flex gap-2">
            <SideNav />
            <div className="w-full px-2 lg:px-12 md:px-12">
              <section className="mt-8">
                <div className="flex justify-center h-screen ">
                  <div className="flex  gap-2 border-2 h-fit p-3 border-gray-400 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-md bg-purple bg-opacity-40 lg:flex-nowrap md:flex-nowrap flex-wrap relative">
                    <Link
                      to="/admin/user"
                    ...
                    <div className="flex flex-col items-center justify-center w-full gap-3 p-3 text-white rounded-md lg:w-80 md:w-80 bg-sideNav">
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <p className="text-lg ">
                          Phone number:
                          <span className="text-base">{user?.phonenumber}</span>
                        </p>
