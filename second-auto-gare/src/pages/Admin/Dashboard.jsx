  ...
  return (
    <>
      <section className="flex gap-6">
        <div className="sticky flex gap-6 ">
          <div
          ...
          >
            ...
            >
              <svg
                ...
                height="25"
                viewBox="0 0 24 24"
                className={`text-white cursor-pointer bg-orange rounded-full p-1 duration-500 ${
                  !open ? "" : "rotate-180"
                } `}
              >
                <g fill="none">
                ...
                return (
                  <NavLink
                    ...
                    className={`flex items-center text-sm gap-3.5 font-medium text-white lg:p-2 md:p-2  group ${
                      i.link === pathname
                        ? "bg-orange rounded text-white"
                        : "hover:bg-orange/50 rounded"
                    }`}
                  >
                    <span>{i.svg}</span>
                    <h1
                    ...
                    <h2
                      className={`${
                        open && "hidden"
                      } absolute left-48 text-base  bg-orange font-semibold whitespace-pre rounded px-0 py-0 text-white w-0 overflow-hidden drop-shadow-lg group-hover:px-2 group-hover:py-1 group-hover:left-20 group-hover:duration-300 group-hover:w-fit`}
                    >
                      {i.name}
                    </h2>
                  </NavLink>
